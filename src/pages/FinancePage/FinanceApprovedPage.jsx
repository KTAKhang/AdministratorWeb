...
function FinanceApprovedPage() {
    ...
    const handleViewDetail = (id) => {
        const path = `/finance/approved/${id}`;
        navigate(path, { state: { mode: "approved" } }); // Truyền mode vào state
    };
    useEffect(() => {
        document.title = "Approved Claims";
    }, []);
    return (
        <>
            <div className="text-[#707EAE] m-1">Claims {">"} Approved</div>
            < div className="px-2 min-h-screen flex flex-col items-center" >
                ...
                <div className="w-full bg-white shadow-lg border rounded-xl p-8 overflow-hidden">
                    ...
                    <div className="flex justify-between items-center mb-6">
                        <h3 className="text-xl font-semibold text-gray-800">Approved Claims</h3>
