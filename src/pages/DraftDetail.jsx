  ...
  return (
    <div className="px-3 bg-white ">
      <div className="text-gray-500 text-sm mb-4">
        Pages &gt; <span className="text-black font-semibold">Draft</span> &gt; Claims Detail
      </div>
        ...
        <div className="mt-6 grid grid-cols-2 gap-6">
          <div className="flex flex-col h-full">
            ...
            <div className="mt-auto flex space-x-4">
              ...
              <button className="bg-orange-500 text-white px-6 py-2 rounded-lg shadow hover:bg-orange-600 w-32 text-center">
                Update
              </button>
